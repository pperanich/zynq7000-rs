...
pub(crate) const RD_ONE: LinearQspiConfig = LinearQspiConfig::builder()
...
pub(crate) const RD_TWO: LinearQspiConfig = LinearQspiConfig::builder()
    .with_enable_linear_mode(true)
...
pub(crate) const FAST_RD_ONE: LinearQspiConfig = LinearQspiConfig::builder()
    .with_enable_linear_mode(true)
    .with_both_memories(false)
    .with_separate_memory_bus(false)
    .with_upper_memory_page(false)
...
pub(crate) const FAST_RD_TWO: LinearQspiConfig = LinearQspiConfig::builder()
    .with_enable_linear_mode(true)
    .with_both_memories(true)
    .with_separate_memory_bus(true)
    .with_upper_memory_page(false)
...
pub(crate) const DUAL_OUT_FAST_RD_ONE: LinearQspiConfig = LinearQspiConfig::builder()
    .with_enable_linear_mode(true)
    .with_both_memories(false)
    .with_separate_memory_bus(false)
    .with_upper_memory_page(false)
...
pub(crate) const DUAL_OUT_FAST_RD_TWO: LinearQspiConfig = LinearQspiConfig::builder()
    .with_enable_linear_mode(true)
    .with_both_memories(true)
    .with_separate_memory_bus(true)
    .with_upper_memory_page(false)
...
pub(crate) const QUAD_OUT_FAST_RD_ONE: LinearQspiConfig = LinearQspiConfig::builder()
    .with_enable_linear_mode(true)
    .with_both_memories(false)
    .with_separate_memory_bus(false)
    .with_upper_memory_page(false)
...
pub(crate) const QUAD_OUT_FAST_RD_TWO: LinearQspiConfig = LinearQspiConfig::builder()
    .with_enable_linear_mode(true)
    .with_both_memories(true)
    .with_separate_memory_bus(true)
    .with_upper_memory_page(false)
...
pub(crate) mod winbond_spansion {
    ...
    pub(crate) const DUAL_IO_FAST_RD_ONE: LinearQspiConfig = LinearQspiConfig::builder()
        .with_enable_linear_mode(true)
        .with_both_memories(false)
        .with_separate_memory_bus(false)
        .with_upper_memory_page(false)
    ...
    pub(crate) const DUAL_IO_FAST_RD_TWO: LinearQspiConfig = LinearQspiConfig::builder()
        .with_enable_linear_mode(true)
        .with_both_memories(true)
        .with_separate_memory_bus(true)
        .with_upper_memory_page(false)
    ...
    pub(crate) const QUAD_IO_FAST_RD_ONE: LinearQspiConfig = LinearQspiConfig::builder()
        .with_enable_linear_mode(true)
        .with_both_memories(false)
        .with_separate_memory_bus(false)
        .with_upper_memory_page(false)
    ...
    pub(crate) const QUAD_IO_FAST_RD_TWO: LinearQspiConfig = LinearQspiConfig::builder()
        .with_enable_linear_mode(true)
        .with_both_memories(true)
        .with_separate_memory_bus(true)
        .with_upper_memory_page(false)
